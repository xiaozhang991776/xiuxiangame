...
const UI = {
    ...
    TUTORIAL_STEPS: [
        ...
        { title: '突破境界', body: '战力攒满，便点「<b>突破</b>」精进境界、增寿元、强根基。每<b>突破大境界</b>会触发<b>天劫</b>（可请护道人化解或硬抗，成功则永久增益修炼与灵石），并<b>觉醒天赋点</b>。※ <b>道祖之后</b>的超脱系（道君→大道共 20 境）突破所需战力暴增 <b>×15</b>，当早做积累。', panel: 'cultivate', target: '#breakBtn' },
        ...
        { title: '转世轮回', body: '此乃本游戏<b>核心玩法</b>。达「<b>战力上线</b>」（随轮回次数递增的战力门槛，<b>道祖之后该门槛亦 ×15</b>）即可<b>免费轮回</b>：重立道基、重置境界与寿元，却<b>永久保留</b>气血与攻击加成。每轮回一世，<b>修炼收益永久 +100%</b>（第 N 世修炼速度 ×(1+N)），气血攻击各 ×(1+0.3N)；轮回上限 <b>100 世</b>。亦可耗 <b>100 株轮回草</b>（坊市有售）直接轮回，不受门槛所限。转世面板已单独显示你的<b>轮回层数</b>。', panel: 'reincarnate', target: '#panel-reincarnate' },
        ...
        { title: '境界全貌', body: '修行之路共 <b>33 大境界 ×15 层</b>：自练气一路攀至 <b>道祖</b>；道祖之后更有 <b>道君→道尊→道圣→…→大道</b> 等 <b>20 个超脱系境界</b>，越往后越近大道本源。※ 道祖之后段位难度（突破战力/灵石门槛、斗法敌人强度）统一 <b>×15</b>，需海量战力方能登顶。达 <b>大乘（大成）期</b> 以上，诸般「<b>绝学重宝</b>」方现世间——坊市解锁 <b>太清宝塔·诸天鼎·无衡镜</b> 等仙界法宝、神通现 <b>太清剑诀→道·无上</b> 诸绝学、灵宠得 <b>麒麟王·祖龙太初</b>，更可飞升 <b>九重天·诸天战场</b> 绝境夺造化。', panel: 'cultivate' },
